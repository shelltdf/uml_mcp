...
const MV_VIEW_KIND_MESSAGES_EN: Record<MvViewKind, ViewKindUi> = {
  ...
  'uml-diagram': {
    canvasTitle: 'Generic UML canvas',
    description:
      'Generic UML record editor; payload uses independent JSON format, while Mermaid/@startuml remain optional plugin capabilities.',
    payloadPlaceholder: '(Generated by Insert dialog from core UML schema mapping)',
  },
  'uml-class': {
    canvasTitle: 'UML class diagram canvas',
    description: 'Class diagram editor; payload uses independent UML JSON record format.',
    payloadPlaceholder: '(Generated by Insert dialog from core UML schema mapping)',
  },
  'uml-object': {
    canvasTitle: 'UML object diagram canvas',
    description: 'Object diagram editor; payload uses independent UML JSON record format.',
    payloadPlaceholder: '(Generated by Insert dialog from core UML schema mapping)',
  },
  'uml-package': {
    canvasTitle: 'UML package diagram canvas',
    description: 'Package diagram editor; payload uses independent UML JSON record format.',
    payloadPlaceholder: '(Generated by Insert dialog from core UML schema mapping)',
  },
  'uml-composite-structure': {
    canvasTitle: 'UML composite structure diagram canvas',
    description: 'Composite structure editor; payload uses independent UML JSON record format.',
    payloadPlaceholder: '(Generated by Insert dialog from core UML schema mapping)',
  },
  'uml-component': {
    canvasTitle: 'UML component diagram canvas',
    description: 'Component diagram editor; payload uses independent UML JSON record format.',
    payloadPlaceholder: '(Generated by Insert dialog from core UML schema mapping)',
  },
  'uml-deployment': {
    canvasTitle: 'UML deployment diagram canvas',
    description: 'Deployment diagram editor; payload uses independent UML JSON record format.',
    payloadPlaceholder: '(Generated by Insert dialog from core UML schema mapping)',
  },
  'uml-profile': {
    canvasTitle: 'UML profile diagram canvas',
    description: 'Profile diagram editor; payload uses independent UML JSON record format.',
    payloadPlaceholder: '(Generated by Insert dialog from core UML schema mapping)',
  },
  'uml-usecase': {
    canvasTitle: 'UML use case diagram canvas',
    description: 'Use case diagram editor; payload uses independent UML JSON record format.',
    payloadPlaceholder: '(Generated by Insert dialog from core UML schema mapping)',
  },
  'uml-sequence': {
    canvasTitle: 'UML sequence diagram canvas',
    description: 'Sequence diagram editor; payload uses independent UML JSON record format.',
    payloadPlaceholder: '(Generated by Insert dialog from core UML schema mapping)',
  },
  'uml-state-machine': {
    canvasTitle: 'UML state machine diagram canvas',
    description: 'State machine diagram editor; payload uses independent UML JSON record format.',
    payloadPlaceholder: '(Generated by Insert dialog from core UML schema mapping)',
  },
  'uml-communication': {
    canvasTitle: 'UML communication diagram canvas',
    description: 'Communication diagram editor; payload uses independent UML JSON record format.',
    payloadPlaceholder: '(Generated by Insert dialog from core UML schema mapping)',
  },
  'uml-timing': {
    canvasTitle: 'UML timing diagram canvas',
    description: 'Timing diagram editor; payload uses independent UML JSON record format.',
    payloadPlaceholder: '(Generated by Insert dialog from core UML schema mapping)',
  },
  'uml-interaction-overview': {
    canvasTitle: 'UML interaction overview diagram canvas',
    description: 'Interaction overview editor; payload uses independent UML JSON record format.',
    payloadPlaceholder: '(Generated by Insert dialog from core UML schema mapping)',
  },
  'uml-activity': {
    canvasTitle: 'UML activity diagram canvas',
    description: 'Activity diagram editor; payload uses independent UML JSON record format.',
    payloadPlaceholder: '(Generated by Insert dialog from core UML schema mapping)',
  },
  'ui-design': {
