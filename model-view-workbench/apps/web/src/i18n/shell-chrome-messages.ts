...
export const shellChromeMessages: Record<AppLocale, ShellChromeMessages> = {
  zh: {
    ...
    tbDiskWorkspaceTitle: 'Electron 工作区 — 无全局快捷键',
    tbFullscreen: '全屏',
    ...
    shellEdit: '独立编辑',
    shellEditTitle: '独立编辑（Electron 宿主或回退为 JSON 对话框）— 无全局快捷键',
    basicProps: '基本属性',
  ...
  en: {
    ...
    tbDiskWorkspaceTitle: 'Electron workspace — no global shortcut',
    ...
    shellEdit: 'Edit externally',
    shellEditTitle: 'External editor (Electron host, or JSON dialog fallback) — no global shortcut',
